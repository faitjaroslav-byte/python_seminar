...
Program bude postupovat jako krátký rozhovor:
...
Když program neběží, zkontroluj hlavně závorky a uvozovky. Jeden znak navíc nebo jeden znak, který chybí, stačí k tomu, aby Python programu nerozuměl.
...
Nyní program rozšíříme tak, aby se zeptal na jméno a pak ho použil v pozdravu.
